...
```
flask-cors permet de faire des requêtes ajax depuis un serveur de cloud qui interroge des machines BIOS terrain sur lesquelles l'API est installée: **plutôt tordu et pas recommandé !**
